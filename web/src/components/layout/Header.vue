<template>
  <header ref="header">
    ...
    <div class="view">
      <img
        ref="imgbg1"
        src="https://cdn.jsdelivr.net/gh/Naccl/blog-resource/img/bg1.jpg"
        style="display: none;"
      >
      <div
        class="bg1"
    ...
    <!-- 设置文字晃动 -->
    <div
      class="text-malfunction"
      data-word="Naccl's Blog"
    >
      <div class="line" />
    </div>
    <!-- 下拉按钮 -->
...
export default {
  ...
  mounted () {
    ...
    header.addEventListener('mousemove', e => {
      const percentage = (e.clientX - startingPoint) / window.outerWidth + 0.5
...
.wave1 {
  background: url('https://cdn.jsdelivr.net/gh/Naccl/blog-resource/img/wave1.png')
    repeat-x;
  height: 75px;
  width: 100%;
}
.wave2 {
  background: url('https://cdn.jsdelivr.net/gh/Naccl/blog-resource/img/wave2.png')
    repeat-x;
  height: 90px;
